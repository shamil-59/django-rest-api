...
def create_recipe(user, **params):
    """Create and return a samlpe recipe."""
    defaults = {
        'title': 'Sample Title',
        'time_minutes': 22,
        'price': Decimal('5.25'),
        'description': 'Sample description',
        'link': 'http://example.cz',
    }
...
def create_user(**params):
    """Create and return a recipe user."""
...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_create_recipe_with_new_tags(self):
        """Test creating sa recipe with new tags."""
        payload = {
    ...
    def test_create_recipe_with_new_ingredients(self):
        """Test creating a recipe whit new ingredients."""
        paylaod = {
    ...
    def test_create_recipe_with_existing_ingredient(self):
        """Test creating a new recipe with existitng ingredients."""
        ingredient = Ingredient.objects.create(user=self.user, name='Potatos')
        payload = {
            'title': 'Vietnames suop',
            'time_minutes': 120,
            'price': Decimal('10.25'),
            'ingredients': [{'name': 'Potatos'}, {'name': 'Salad'}],
        }
        res = self.client.post(RECIPES_URL, payload, format='json')
